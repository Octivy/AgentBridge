...
> 2026-08-14 用户决策：原两条窗的人工核对项**取消**（暂不清楚人工图纸文件位置）。
> 连接链路验证通过后，改用**新图纸**做 Rhino 管线测试。原两条遗留项关闭。

| # | 洞口位置 | 宽 | 原状 | 处理 |
| --- | --- | --- | --- | --- |
| 1 | (40656530.8, 3303285.6) | 700 | 两侧墙线 100mm 短段，挂接依赖容差 | 取消核对，新图纸验证 |
| 2 | (40682180.8, 3292735.6) | 1500 | 图纸无墙线，疑似漏画 | 取消核对，新图纸验证 |
